...
<textarea name="comment" rows="8" class="form-control" placeholder="<?php echo !empty($field_comment['placeholder']) ? $field_comment['placeholder'] : ''; ?>"><?php echo $comment ? $comment : $field_comment['default']; ?></textarea>
<?php } else { ?>
