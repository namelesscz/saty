...
class ControllerCheckoutGuest extends Controller {
	...
	public function save() {
		...
		if (!$json) {
			...
			$this->session->data['guest']['email'] = ($this->request->post['email'] ?  $this->request->post['email']: ((isset($this->request->post['payment_address']['email']))? $this->request->post['payment_address']['email'] : ''));
