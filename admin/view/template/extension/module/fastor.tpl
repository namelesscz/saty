...
<!--                                            
						...
						<div id="tab_header" class="tab-content">
                            ...
                            <div class="section">
                                ...
                                Headers color you can change in Design & Colors â€s Colors
                                </p>
                            </div>
                            ...
                            <div class="section">
                                ...
                                <div class="section-content">
                                    ...
                                    <div class="input">
                                        ...
                                        <a href="http://findmyfacebookid.com/" target="_blank" style="display: block;float: left;width: auto;margin-top: 7px">Find your Facebook ID Â»</a>
					...
					<div id="tab_install_data" class="tab-content">
                        ...
                        <div class="section">
                            <p style="font-family:Open Sans;color:#4c4c4c;font-size:12px;line-height: 21px;padding-top: 12px">Our theme is MultiStore ready and you can install sample data for each store with some restrictions. Demo content for modules: <b>â€sAdvanded Gridâ€t</b> and <b>â€sCustom Moduleâ€t</b> is added as new module on the list. Demo content for other module is replaced. If you have already <b>â€sMegaMenuâ€t</b> craeted and you install new demo content for this module, the old one will be replaced.<br><br>If you want to make your shop look exactly like our demo. Install sample data.</p>
					...
					<div id="tab_advanced_settings" class="tab-content">
                        <div class="relative">
                            ...
                            <div class="advanced_description">
                                ...
                                <br>
                                <p>
                                    And because itâ€™s should be easy to check each type we created live editor for these settings
                                </p>
                            </div>
                        </div>
