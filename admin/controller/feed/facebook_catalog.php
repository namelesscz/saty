...
class ControllerFeedFacebookCatalog extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('feed/facebook_catalog', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('feed/facebook_catalog', 'token=' . $this->session->data['token'], true);
