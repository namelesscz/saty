                    ...
                    <div class="tab-pane" id="tab-option<?php echo $option_row; ?>">
                      ...
                      <div class="table-responsive">
                        <table id="option-value<?php echo $option_row; ?>" class="table table-striped table-bordered table-hover">
                          <thead>
                            <tr>
 <td class="text-left"><?php echo $entry_option_sku; ?></td> 
...
$('input[name=\'option\']').autocomplete({
	...
	'select': function(item) {
		...
		if (item['type'] == 'select' || item['type'] == 'radio' || item['type'] == 'checkbox' || item['type'] == 'image') {
			...
			html += '  	 <thead>';
			html += '      <tr>';
 html += '        <td class="text-left"><?php echo $entry_option_sku; ?></td>'; 
...
function addOptionValue(option_row) {
 ...
 html += '  <td class="text-right"><input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][option_sku]" value="" placeholder="<?php echo $entry_option_sku; ?>" class="form-control" /></td>'; 
