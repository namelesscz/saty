...
class ModelCheckoutOrder extends Model {
	public function addOrder($data) {
				...
				$this->db->query("INSERT INTO `" . DB_PREFIX . "order` SET branch_id = '" . $this->db->escape(((!empty($data['branch_id'])) ? $data['branch_id'] : 0)) . "', invoice_prefix
