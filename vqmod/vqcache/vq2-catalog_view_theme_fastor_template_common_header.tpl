...
?>
<!DOCTYPE html>
<!--[if IE 7]> <html lang="<?php echo $lang; ?>" class="ie7 <?php if($theme_options->get( 'responsive_design' ) == '0') { echo 'no-'; } ?>responsive<?php echo (array_key_exists($config->get( 'config_language_id' ),$page_direction) && $page_direction[$config->get( 'config_language_id' )] == 'RTL' ? ' rtl' : '' ) ?>" <?php echo (array_key_exists($config->get( 'config_language_id' ),$page_direction) && $page_direction[$config->get( 'config_language_id' )] == 'RTL' ? 'dir="rtl"' : '' ) ?>> <![endif]-->
<!--[if IE 8]> <html lang="<?php echo $lang; ?>" class="ie8 <?php if($theme_options->get( 'responsive_design' ) == '0') { echo 'no-'; } ?>responsive<?php echo (array_key_exists($config->get( 'config_language_id' ),$page_direction) && $page_direction[$config->get( 'config_language_id' )] == 'RTL' ? ' rtl' : '' ) ?>" <?php echo (array_key_exists($config->get( 'config_language_id' ),$page_direction) && $page_direction[$config->get( 'config_language_id' )] == 'RTL' ? 'dir="rtl"' : '' ) ?>> <![endif]-->
<!--[if IE 9]> <html lang="<?php echo $lang; ?>" class="ie9 <?php if($theme_options->get( 'responsive_design' ) == '0') { echo 'no-'; } ?>responsive<?php echo (array_key_exists($config->get( 'config_language_id' ),$page_direction) && $page_direction[$config->get( 'config_language_id' )] == 'RTL' ? ' rtl' : '' ) ?>" <?php echo (array_key_exists($config->get( 'config_language_id' ),$page_direction) && $page_direction[$config->get( 'config_language_id' )] == 'RTL' ? 'dir="rtl"' : '' ) ?>> <![endif]-->
<!--[if !IE]><!--> <html lang="<?php echo $lang; ?>" class="<?php if($theme_options->get( 'responsive_design' ) == '0') { echo 'no-'; } ?>responsive<?php echo (array_key_exists($config->get( 'config_language_id' ),$page_direction) && $page_direction[$config->get( 'config_language_id' )] == 'RTL' ? ' rtl' : '' ) ?>" <?php echo (array_key_exists($config->get( 'config_language_id' ),$page_direction) && $page_direction[$config->get( 'config_language_id' )] == 'RTL' ? 'dir="rtl"' : '' ) ?>> <!--<![endif]-->
<head>
	...
	//RTL
	if(array_key_exists($config->get( 'config_language_id' ),$page_direction) &&  $page_direction[$config->get( 'config_language_id' )] == 'RTL'){
...
<!-- Glami piXel for ŠatyNaJednicku.cz -->
<script>
...
<?php if (isset($facebook_remarketing)) echo $facebook_remarketing; ?>
<?php if (isset($google_adwords_code)) echo $google_adwords_code; ?>
</head>
...
<?php if (isset($google_legacy_code) && $google_legacy_code!="") echo '<div style="display:none;">'.$google_legacy_code.'</div>'; ?>
